...
export const Header = () => {
    ...
    const { person, home, about, finance, cafe } = renderContent(t);
                        ...
                        <Flex
                            ...
                            { routes['/finance'] && (
                                <ToggleButton
                                    ...
                                    <Flex paddingX="2" hide="s">{finance.label}</Flex>
                                </ToggleButton>
                            )}
                            { routes['/cafe'] && (
                                <ToggleButton
                                    prefixIcon="cafe"
                                    href={`/${params?.locale}/cafe`}
                                    selected={pathname.startsWith('/cafe')}>
                                    <Flex paddingX="2" hide="s">{cafe.label}</Flex>
                                </ToggleButton>
                            )}
                            {/* { routes['/blog'] && (
                                <ToggleButton
