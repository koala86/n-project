...
const createI18nContent = (t) => {
    const person = {
        ...
        languages: ['Japanese']  // optional: Leave the array empty if you don't want to display languages
    }
    ...
    const cafe = {
        label: t("cafe.label"),
        title: t("cafe.title"),
        description: t("cafe.description", {name: person.name})
        // Create new blog posts by adding a new .mdx file to app/blog/posts
        // All posts will be listed on the /blog route
    }
    ...
    const finance = {
        ...
        description: t("finance.description", {name: person.name})
